...
class MailerTests(TestCase):
    def test_send_invitation_mail(self):
        ...
        self.assertTrue(re.search(r'https://ironcage-dev.herokuapp.com/tickets/invitations/\w{12}/', email.body))
    ...
    def test_send_order_confirmation_mail_for_order_for_self(self):
        ...
        self.assertTrue(re.search(fr'https://ironcage-dev.herokuapp.com/tickets/orders/{order.order_id}/receipt/', email.body))
